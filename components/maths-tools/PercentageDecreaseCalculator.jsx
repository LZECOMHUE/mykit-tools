...
export default function PercentageDecreaseCalculator() {
  ...
  const reverseResult = useMemo(() => {
    ...
    const decreaseAmount = val1 - val2;
    const percentageDecrease = (decreaseAmount / val1) * 100;
    ...
    <div className="space-y-3">
      ...
      {mode === 'forward' && forwardResult && (
        <div className="space-y-4">
          ...
          <div className="p-4 rounded-[var(--radius-card)] border border-border bg-surface">
            <div className="text-sm text-text-secondary mb-1">Decrease Amount</div>
            <div className="text-2xl font-bold font-mono-num text-text-primary">
              −{forwardResult.decreaseAmount.toFixed(4)}
            </div>
          </div>
        </div>
      )}
      ...
      {mode === 'reverse' && reverseResult && (
        <div className="space-y-4">
          ...
          <div className="p-4 rounded-[var(--radius-card)] border border-border bg-surface">
            <div className="text-sm text-text-secondary mb-1">Absolute Decrease</div>
            <div className="text-2xl font-bold font-mono-num text-text-primary">
              −{reverseResult.decreaseAmount.toFixed(4)}
            </div>
          </div>
        </div>
      )}
