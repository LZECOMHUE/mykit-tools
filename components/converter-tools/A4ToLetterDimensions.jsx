...
export default function A4ToLetterDimensions() {
  const formats = [
    {
      name: "A4",
      mmWidth: 210,
          ...
          <Card key={idx} className="p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="mt-4 pt-4 border-t border-border">
                <div className={`w-full aspect-[8.27/11.69] ${format.color} rounded border-2 border-border flex items-center justify-center`}>
      ...
      <Card className="p-6">
        ...
        <div className="space-y-3">
          <p className="text-sm text-text-secondary">
            A4 is the international standard for paper size, widely used in
            Europe and most countries. US Letter is the standard in the United
            States and Canada.
          </p>
          <div className="bg-surface p-4 rounded border border-border space-y-2">
            <p className="text-sm">
              ...
              <span className="ml-2 font-mono text-text-secondary">
                {(215.9 - 210).toFixed(1)} mm (0.23 in) wider
              </span>
            </p>
            <p className="text-sm">
              <span className="font-medium text-text-primary">Height difference:</span>
              <span className="ml-2 font-mono text-text-secondary">
                {(297 - 279.4).toFixed(1)} mm (0.69 in) taller
              </span>
            </p>
          </div>
        </div>
