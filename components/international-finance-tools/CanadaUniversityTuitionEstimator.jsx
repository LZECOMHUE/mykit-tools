    ...
    <div className="bg-surface rounded-lg p-4 space-y-4">
      ...
      <div className="grid md:grid-cols-3 gap-4">
        <div className="bg-surface border border-border rounded-lg p-4">
          <div className="text-sm text-text-secondary mb-2">Annual Tuition</div>
        ...
        <div className="bg-surface border border-border rounded-lg p-4">
          <div className="text-sm text-text-secondary mb-2">Living Expenses/Year</div>
          <div className="text-3xl font-mono font-bold text-text-primary">
        ...
        <div className="bg-surface border border-border rounded-lg p-4">
          <div className="text-sm text-text-secondary mb-2">Books/Supplies/Year</div>
          <div className="text-3xl font-mono font-bold text-text-primary">
      ...
      {/* Funding Options */}
      <div className="bg-surface border border-border rounded-lg p-4">
        <h3 className="font-semibold text-text-primary mb-3">Funding Options</h3>
