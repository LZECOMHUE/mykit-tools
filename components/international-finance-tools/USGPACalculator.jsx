  ...
  return (
    <div className="w-full space-y-4">
      ...
      <div className="bg-accent/5 border border-accent/20 rounded-lg p-5">
        <p className="text-accent text-sm font-medium mb-1">Cumulative GPA</p>
        <p className="font-mono text-5xl font-bold text-accent">{calculations.gpa}</p>
        <p className="text-accent text-xs mt-2">{calculations.breakdown}</p>
      </div>

      {/* Honors */}
      {calculations.honors && (
        <div className="bg-surface border border-border rounded-lg p-4">
          <p className="text-text-secondary text-sm font-medium mb-1">Latin Honors</p>
          <p className="font-semibold text-text-primary">{calculations.honors}</p>
        </div>
      )}
