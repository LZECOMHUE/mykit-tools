    ...
    <div className="space-y-4">
      ...
      {!image && (
        ...
        >
          ...
          <p className="text-sm text-text-muted">PNG, WebP, or any image format</p>
        ...
        <>
          ...
          {transparent && (
            <Card className="border-amber-300 bg-amber-50">
              <div className="flex items-start gap-2">
                ...
                <div>
                  <p className="text-sm font-medium text-text-primary">This image has transparent areas</p>
          ...
          <Card>
            <div className="space-y-4">
              ...
              {transparent && (
                <div>
                  <p className="text-sm font-medium text-text-primary mb-2">Background Colour</p>
          ...
          {converted && (
            <Card>
              <div className="grid grid-cols-2 gap-4 text-center">
                ...
                <div>
                  <p className="text-xs text-text-muted uppercase tracking-wide">JPG Output</p>
                  <p className="font-mono text-lg text-text-primary">{formatBytes(jpgSize || 0)}</p>
                </div>
              </div>
              {reduction !== null && (
          ...
          {jpgUrl && (
            <Card padding={false}>
              <img src={jpgUrl} alt="JPG preview" className="max-w-full rounded-[var(--radius-card)]" />
            </Card>
          )}
