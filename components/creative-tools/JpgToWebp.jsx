    ...
    <div className="space-y-4">
      ...
      {!image && (
        ...
        >
          ...
          <p className="font-medium text-text-primary mb-1">Drop a JPG here or click to upload</p>
          <p className="text-sm text-text-muted">JPG, JPEG, or any image format</p>
      ...
      {image && (
        <>
          ...
          {converted && (
            <Card>
              <div className="grid grid-cols-2 gap-4 text-center">
                <div>
                  <p className="text-xs text-text-muted uppercase tracking-wide">Original JPG</p>
              ...
              <p className="text-xs text-text-muted text-center mt-1">WebP is typically 25-35% smaller than JPG at the same visual quality</p>
            </Card>
          )}
          ...
          {webpUrl && (
            <Card padding={false}>
              <img src={webpUrl} alt="WebP preview" className="max-w-full rounded-[var(--radius-card)]" />
            </Card>
          )}
