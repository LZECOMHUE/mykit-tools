export const categories = [
  ...
  { slug: "music", name: "Music", icon: "\u{1F3B5}", color: "cat-music", description: "Tuners, metronomes, chord libraries, scale finders, theory references, practice tools" },
  ...
  { slug: "pdf", name: "PDF & Image Tools", icon: "\u{1F4C4}", color: "cat-pdf", description: "Merge, split, rotate, compress PDFs. Convert images to PDF and back. Watermark, protect, and edit documents" },
  { slug: "betting", name: "Betting & Gambling", icon: "\u{1F3B0}", color: "cat-betting", description: "Lottery number pickers, matched betting calculators, odds converters, accumulator tools, dutching and lay bet calculators" },
  { slug: "maps", name: "Maps & Distance", icon: "\u{1F4CD}", color: "cat-maps", description: "Find nearby places, walking routes, distance calculators, postcode tools, interactive map tools" },
];
